...
const TOOLS = [
  ...
  },
  {
    ...
    description:
      "Get a specific Conseil de la Concurrence decision by case number (e.g., 'B6-22/16').",
    inputSchema: {
      type: "object" as const,
      properties: {
  ...
  },
  {
    ...
    description:
      "Search Conseil de la Concurrence merger control decisions (Fusionskontrolle).",
    inputSchema: {
      type: "object" as const,
      properties: {
  ...
  },
  {
    ...
    description:
      "List all sectors with Conseil de la Concurrence enforcement activity, including decision and merger counts.",
